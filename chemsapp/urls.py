...
urlpatterns = [
    ...
    re_path(r'^product-dashboard/sync-all-geller-ai/$',
            product_dashboard_views.sync_all_products_to_geller_ai, name='sync_all_products_to_geller_ai'),
    re_path(r'^product-dashboard/sync-all-geller-ai/(?P<run_id>[0-9a-f-]+)/status/$',
            product_dashboard_views.sync_all_products_status, name='sync_all_products_status'),
